...
public class ManagerServer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Account> listLogin = dAOAccount.unAcceptedAccounts("select * from Account where role = 0");
        List<Account> listSell = dAOAccount.unAcceptedAccounts("select * from Account where role = 3");
        List<Request> listRequest = daoRequest.getAllRequest();
